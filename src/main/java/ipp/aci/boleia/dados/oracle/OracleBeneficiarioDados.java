        ...
        if(filtro.getBeneficios() != null && !filtro.getBeneficios().isEmpty()){
            ...
            filtro.getBeneficios().forEach(beneficio -> {
                ParametroPesquisaAnd parametroBeneficio = new ParametroPesquisaAnd(
                        new ParametroPesquisaIgual("contaBeneficiario.configuracoesTipoBeneficio.tipoConfigurado.id", beneficio.getId()),
                        new ParametroPesquisaIgual("contaBeneficiario.configuracoesTipoBeneficio.beneficioConfigurado", true)
                );
