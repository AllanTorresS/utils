...
public class OracleTransacaoConsolidadaDados extends OracleRepositorioBoleiaDados<TransacaoConsolidada>
    ...
    private static final String BASE_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_QUE_CONTEM_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS =
            "FROM " +
                    "AutorizacaoPagamento AP " +
    ...
    private static final String CLAUSULA_SELECT_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_ORIGINAIS_QUE_CONTEM_CANCELADOS_OU_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS =
            "SELECT DISTINCT AP.transacaoConsolidada.id ";

    private static final String CLAUSULA_SELECT_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_DE_POSTERGACAO_QUE_CONTEM_CANCELADOS_OU_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS =
            "SELECT DISTINCT AP.transacaoConsolidadaPostergada.id ";

    private static final String BASE_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_QUE_CONTEM_CANCELADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS =
                    "FROM " +
                    "AutorizacaoPagamento AP " +
                    "JOIN AP.transacaoConsolidada TC " +
                    "JOIN TC.frotaPtov FP " +
...
//                    "AND AP.transacaoConsolidadaPostergada.id = (SELECT DISTINCT APNEG.transacaoConsolidada.id FROM AutorizacaoPagamento APNEG WHERE APNEG.idAutorizacaoEstorno = AP.id AND APNEG.valorTotal < 0) ";
    ...
    private String obterConsultaCompletaDoGridDoFinanceiro(String ordenacao){
        ...
        String consultaCiclosOriginaisQueSoTemCancelados = CLAUSULA_SELECT_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_ORIGINAIS_QUE_CONTEM_CANCELADOS_OU_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS
                + BASE_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_QUE_CONTEM_CANCELADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS;
        ...
        //Nota: A query segue a mesma logica utilizada para exibir ou nao exibir/contabilizar ou nao contabilizar os abastecimentos cancelados na quantidade de transacoes na grid do financeiro e na tela de notas fiscais na visao da revenda
        String consultaCiclosDePostergacaoQueSoTemCancelados = CLAUSULA_SELECT_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_DE_POSTERGACAO_QUE_CONTEM_CANCELADOS_OU_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS
                + BASE_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_QUE_CONTEM_CANCELADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS;
...
//                + COMPLEMENTO_CLAUSULA_WHERE_CONSULTA_CONSOLIDADOS_GRID_FINANCEIRO_CICLOS_DE_POSTERGACAO_QUE_CONTEM_ESTORNADOS_QUE_DEVEM_SER_EXIBIDOS_E_CONTABILIZADOS;
        ...
        consultaPesquisaGridFinanceiro = consultaPesquisaGridFinanceiro.replace("%QUERY_IDS_CICLOS_ORIGINAIS_COM_CANCELADOS%",consultaCiclosOriginaisQueSoTemCancelados);
        consultaPesquisaGridFinanceiro = consultaPesquisaGridFinanceiro.replace("%QUERY_IDS_CICLOS_DE_POSTERGACAO_COM_CANCELADOS%",consultaCiclosDePostergacaoQueSoTemCancelados);
