...
public final class ChavePermissao {
    ...
    public static final String AGENCIADOR_FRETE_PRECO_CONSULTAR = SPRING_ROLE_PREFIX + "AGENCIADOR_FRETE_PRECO_CONSULTAR" + SPRING_ROLE_SUFFIX;
    public static final String AGENCIADOR_FRETE_PRECO_INCLUIR = SPRING_ROLE_PREFIX + "AGENCIADOR_FRETE_PRECO_INCLUIR" + SPRING_ROLE_SUFFIX;
    public static final String AGENCIADOR_FRETE_PRECO_ALTERAR = SPRING_ROLE_PREFIX + "AGENCIADOR_FRETE_PRECO_ALTERAR" + SPRING_ROLE_SUFFIX;
    public static final String AGENCIADOR_FRETE_PRECO_EXCLUIR = SPRING_ROLE_PREFIX + "AGENCIADOR_FRETE_PRECO_EXCLUIR" + SPRING_ROLE_SUFFIX;
