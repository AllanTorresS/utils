...
public enum Erro {
    ...
    NOTAS_FISCAIS_SEPARADAS_NAO_ENCONTRADAS(165),
    NOTA_FISCAL_COMB_OU_PROD_AUSENTE(166),
    NOTA_FISCAL_VALOR_COMB_EXCEDENTE(167),
    NOTA_FISCAL_VALOR_PROD_EXCEDENTE(168),
    NOTA_FISCAL_VALOR_COMB_FALTANTE(169),
    NOTA_FISCAL_VALOR_PROD_FALTANTE(170),
    NOTA_FISCAL_ABASTECIMENTO_ENCONTRADO_FLAG_SEPARACAO(171);
