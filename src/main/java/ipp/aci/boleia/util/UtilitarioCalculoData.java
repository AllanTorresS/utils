...
public final class UtilitarioCalculoData {
     ...
     * @return A data resultante da operacao
     */
    public static Date definirTempoData(Date data, int valorCampoData, int unidadeTempo) {public static Date definirTempoData(Date data, int valorCampoData, int unidadeTempo) {
        if (data == null) {
            return null;
        }
        Calendar c = Calendar.getInstance();
