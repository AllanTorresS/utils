...
public enum Rotina implements IEnumComLabel<Rotina> {
    ...
    EXCLUSAO_DADOS_MOTORISTAS(42),
    AVISO_MOTORISTAS_INAVAVOS_E_SEM_ABASTECIMENTO(43),
	DISTRIBUICAO_AUTOMATICA_DE_BENEFICIOS(44),
    CANCELAMENTO_CHAMADOS_PENDENTES(45),
    ATUALIZACAO_PEDIDO_CREDITO_BENEFICIOS(46);
