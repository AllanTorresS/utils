...
public enum LockAgendamento {
    ...
    ATUALIZACAO_DADOS_TELEMETRIA_SASCAR             (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    ATUALIZACAO_VEICULOS_SASCAR                     (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    PROPAGACAO_DE_PRECOS_FROTA                      (ConstantesDuracao.UMA_HORA, ConstantesDuracao.UM_SEGUNDO),
    ATUALIZACAO_DADOS_TELEMETRIA_ONIXSAT            (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    ATUALIZACAO_VEICULOS_ONIXSAT                    (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    VIGENCIA_IMPORTACAO_PRECO_POSTO                 (ConstantesDuracao.UM_MINUTO_E_MEIO, ConstantesDuracao.UM_SEGUNDO),
    BUSCA_DADOS_CONNECTCTA                          (ConstantesDuracao.CINCO_MINUTOS,ConstantesDuracao.UM_SEGUNDO),
    CONCILIACAO_POS_ABASTECE_AI                     (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    ENVIO_REPASSE_JDE                               (ConstantesDuracao.UMA_HORA, ConstantesDuracao.UM_SEGUNDO),
    CONCILIACAO_REPASSE                             (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    ATUALIZACAO_STATUS_CAMPANHA                     (ConstantesDuracao.CINCO_MINUTOS, ConstantesDuracao.UM_SEGUNDO),
    ...
    EMAIL_MENSAL_KMV_DONO_FROTA                     (ConstantesDuracao.CINCO_MINUTOS,ConstantesDuracao.UM_SEGUNDO);
