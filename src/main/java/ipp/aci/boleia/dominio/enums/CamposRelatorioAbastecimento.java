...
public enum CamposRelatorioAbastecimento {
    ...
    HORA_ABASTECIMENTO(105, "enum.CamposRelatorioAbastecimento.HORA_ABASTECIMENTO.label", true, true,true, 1, 25, false),
    DATA_ABASTECIMENTO(106, "enum.CamposRelatorioAbastecimento.DATA_ABASTECIMENTO.label", true, true,true, 1, 25, false),
    CNPJ_FROTA_MATRIZ(200, "enum.CamposRelatorioAbastecimento.CNPJ_FROTA_MATRIZ.label", true, true,true, 2, 25, false),
    RAZAO_SOCIAL_FROTA_MATRIZ(201, "enum.CamposRelatorioAbastecimento.RAZAO_SOCIAL_FROTA_MATRIZ.label", true,true, true, 2, 50, false),
    CNPJ_UNIDADE(202, "enum.CamposRelatorioAbastecimento.CNPJ_UNIDADE.label", true, true,true, 2, 25, false),
    RAZAO_SOCIAL_UNIDADE(203, "enum.CamposRelatorioAbastecimento.RAZAO_SOCIAL_UNIDADE.label", true, true,true, 2, 50, false),
    CIDADE_UNIDADE(204, "enum.CamposRelatorioAbastecimento.CIDADE_UNIDADE.label", true, true,true, 2, 30, false),
    UF_UNIDADE(205, "enum.CamposRelatorioAbastecimento.UF_UNIDADE.label", true, true,true, 2, 30, false),
    NOME_FANTASIA_FROTA(206, "enum.CamposRelatorioAbastecimento.NOME_FANTASIA_FROTA.label", false, true,true, 2, 50, false),
    CNPJ_EMPRESA_AGREGADA(300, "enum.CamposRelatorioAbastecimento.CNPJ_EMPRESA_AGREGADA.label", true, true,true, 3, 25, false),
    RAZAO_SOCIAL_EMPRESA_AGREGADA(301, "enum.CamposRelatorioAbastecimento.RAZAO_SOCIAL_EMPRESA_AGREGADA.label", true, true,true, 3, 50, false),
    CIDADE_EMPRESA_AGREGADA(302, "enum.CamposRelatorioAbastecimento.CIDADE_EMPRESA_AGREGADA.label", true, true,true, 3, 30, false),
    UF_EMPRESA_AGREGADA(303, "enum.CamposRelatorioAbastecimento.UF_EMPRESA_AGREGADA.label", true, true,true, 3, 30, false),
    CODIGO_CENTRO_DE_CUSTO(400, "enum.CamposRelatorioAbastecimento.CODIGO_CENTRO_DE_CUSTO.label", false, true,false, 4, 25, false),
    NOME_CENTRO_DE_CUSTO(401, "enum.CamposRelatorioAbastecimento.NOME_CENTRO_DE_CUSTO.label", false, true,false, 4, 50, false),
    ...
    CPF_MOTORISTA(600, "enum.CamposRelatorioAbastecimento.CPF_MOTORISTA.label", true, true,true, 6, 20, false),
    NOME_MOTORISTA(601, "enum.CamposRelatorioAbastecimento.NOME_MOTORISTA.label", true, true,true, 6, 30, false),
    MATRICULA_MOTORISTA(602, "enum.CamposRelatorioAbastecimento.MATRICULA_MOTORISTA.label", false, true,true, 6, 30, false),
    RASTREADOR(603, "enum.CamposRelatorioAbastecimento.RASTREADOR.label", false, true,true, 6, 15, false),
    LAT_LONG_DISPOSITIVO(604, "enum.CamposRelatorioAbastecimento.LAT_LONG_DISPOSITIVO.label", false, true,true, 6, 45, false),
    LAT_LONG_VEICULO_RASTREADOR(605, "enum.CamposRelatorioAbastecimento.LAT_LONG_VEICULO_RASTREADOR.label", false, true,true, 6, 45, false),
    LAT_LONG_POSTO(606, "enum.CamposRelatorioAbastecimento.LAT_LONG_POSTO.label", false, true,true, 6, 45, false),
    HODOMETRO_HORIMETRO_RASTREADOR(607, "enum.CamposRelatorioAbastecimento.HODOMETRO_HORIMETRO_RASTREADOR.label", false, true,true, 6, 45, false),
    HODOMETRO_HORIMETRO(608, "enum.CamposRelatorioAbastecimento.HODOMETRO_HORIMETRO.label", true, true,true, 6, 40, false),
    HODOMETRO_HORIMETRO_ANTERIOR(609, "enum.CamposRelatorioAbastecimento.HODOMETRO_HORIMETRO_ANTERIOR.label", false, true,true, 6, 40, false),
    HODOMETRO_HORIMETRO_PERCORRIDO(610, "enum.CamposRelatorioAbastecimento.HODOMETRO_HORIMETRO_PERCORRIDO.label", false, true,true, 6, 40, false),
    MEDIA_KML_LH(611, "enum.CamposRelatorioAbastecimento.MEDIA_KML_LH.label", false, true,true, 6, 30, false),
    FOTO_HOD_HOR(612, "enum.CamposRelatorioAbastecimento.FOTO_HOD_HOR.label", false, true,true, 6, 30, false),
    JUSTIFICATIVA_FOTO_HOD_HOR(613, "enum.CamposRelatorioAbastecimento.JUSTIFICATIVA_FOTO_HOD_HOR.label", false, true,true, 6, 50, false),
    MODO(614, "enum.CamposRelatorioAbastecimento.MODO.label", true, true,true, 6, 15, false),
    MEIO_PAGAMENTO(615, "enum.CamposRelatorioAbastecimento.MEIO_PAGAMENTO.label", true, true,true, 6, 40, false),
    TIPO_AUTORIZACAO(616, "enum.CamposRelatorioAbastecimento.TIPO_AUTORIZACAO.label", false, true,true, 6, 30, false),
    HODOMETRO_HORIMETRO_DISPOSITIVO(617, "enum.CamposRelatorioAbastecimento.HODOMETRO_HORIMETRO_DISPOSITIVO.label", false, true,true, 6, 50, false),
    ...
    LITROS(708, "enum.CamposRelatorioAbastecimento.LITROS.label", true, true, true,7, 20, false),
    LITROS_VALOR_UNITARIO_PRODUTO(709, "enum.CamposRelatorioAbastecimento.LITROS_VALOR_UNITARIO_PRODUTO.label", true, true,true, 7, 30, false),
    LITROS_VALOR_TOTAL_PRODUTO(710, "enum.CamposRelatorioAbastecimento.LITROS_VALOR_TOTAL_PRODUTO.label", true, true, true,7, 30, false),
    ALIMENTACAO(711, "enum.CamposRelatorioAbastecimento.ALIMENTACAO.label", true, true,true, 7, 30, false),
    ALIMENTACAO_VALOR_UNITARIO_SERVICO(712, "enum.CamposRelatorioAbastecimento.ALIMENTACAO_VALOR_UNITARIO_SERVICO.label", true, true,true, 7, 30, false),
    ALIMENTACAO_VALOR_TOTAL_SERVICO(713, "enum.CamposRelatorioAbastecimento.ALIMENTACAO_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    ARLA_32_BALDE(714, "enum.CamposRelatorioAbastecimento.ARLA_32_BALDE.label", true, true, true,7, 30, false),
    ARLA_32_BALDE_VALOR_UNITARIO_SERVICO(715, "enum.CamposRelatorioAbastecimento.ARLA_32_BALDE_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
    ARLA_32_BALDE_VALOR_TOTAL_SERVICO(716, "enum.CamposRelatorioAbastecimento.ARLA_32_BALDE_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    ARLA_32_GRANEL(717, "enum.CamposRelatorioAbastecimento.ARLA_32_GRANEL.label", true, true, true,7, 30, false),
    ARLA_32_GRANEL_VALOR_UNITARIO_SERVICO(718, "enum.CamposRelatorioAbastecimento.ARLA_32_GRANEL_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
    ARLA_32_GRANEL_VALOR_TOTAL_SERVICO(719, "enum.CamposRelatorioAbastecimento.ARLA_32_GRANEL_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    BORRACHARIA(720, "enum.CamposRelatorioAbastecimento.BORRACHARIA.label", true, true, true,7, 30, false),
    BORRACHARIA_VALOR_UNITARIO_SERVICO(721, "enum.CamposRelatorioAbastecimento.BORRACHARIA_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
    BORRACHARIA_VALOR_TOTAL_SERVICO(722, "enum.CamposRelatorioAbastecimento.BORRACHARIA_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    LAVAGEM(723, "enum.CamposRelatorioAbastecimento.LAVAGEM.label", true, true, true,7, 30, false),
    LAVAGEM_VALOR_UNITARIO_SERVICO(724, "enum.CamposRelatorioAbastecimento.LAVAGEM_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
    LAVAGEM_VALOR_TOTAL_SERVICO(725, "enum.CamposRelatorioAbastecimento.LAVAGEM_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    MANUTENCAO(726, "enum.CamposRelatorioAbastecimento.MANUTENCAO.label", true, true, true,7, 30, false),
    MANUTENCAO_VALOR_UNITARO_SERVICO(727, "enum.CamposRelatorioAbastecimento.MANUTENCAO_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
    MANUTENCAO_VALOR_TOTAL_SERVICO(728, "enum.CamposRelatorioAbastecimento.MANUTENCAO_VALOR_TOTAL_SERVICO.label", true, true, true,7, 30, false),
    TROCA_OLEO(729, "enum.CamposRelatorioAbastecimento.TROCA_OLEO.label", true, true, true,7, 30, false),
    TROCA_OLEO_VALOR_UNITARO_SERVICO(730, "enum.CamposRelatorioAbastecimento.TROCA_OLEO_VALOR_UNITARIO_SERVICO.label", true, true, true,7, 30, false),
     ...
     */
    CamposRelatorioAbastecimento(int codigo, String label, boolean visaoPosto, boolean visaoFrota, boolean visaoSolucao, int categoria, int larguraColunaTxt, boolean oculto) {
        this.codigo = codigo;
        this.label = label;
