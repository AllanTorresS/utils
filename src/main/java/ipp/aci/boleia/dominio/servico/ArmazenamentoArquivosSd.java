...
public class ArmazenamentoArquivosSd {
    ...
    public void montarMapaRepositorios() {
        ...
        repositoriosPorTipoArquivo.put(TipoArquivo.DOWNLOAD_PRESIGNED_NOTA_FISCAL_PDF_ZIP, arquivoDados);
        repositoriosPorTipoArquivo.put(TipoArquivo.DOWNLOAD_PRESIGNED_NOTA_FISCAL_XML_ZIP, arquivoDados);
