 ...
 */
public class BoletoConectcarVo {
	...
	private AvisoDebitoConectcarVo avisoDebito;
	...
	public AvisoDebitoConectcarVo getAvisoDebito() {
		return avisoDebito;
	}

	public void setAvisoDebito(AvisoDebitoConectcarVo avisoDebito) {
