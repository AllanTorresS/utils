...
public class AvisoDebitoVo {
    ...
    private List<DetalheAbastecimentoVo> detalhes;
    ...
    public List<DetalheAbastecimentoVo> getDetalhes() {
        return detalhes;
    }

    public void setDetalhes(List<DetalheAbastecimentoVo> detalhes) {
